...
main_menu() {
    while true; do
        ...
        echo "21) Gamescope"
        echo "22) Affinity Photo (AppImage)"
        echo "23) IWD (iNet Wireless Daemon)"
        ...
        case $opcao in
            ...
            19) kdenlive_installer ;;
            20) fish_fisher_installer ;;
            21) gamescope_installer ;;
            22) affinity_installer ;;
            23) iwd_installer ;;
            24) mise_installer ;;
