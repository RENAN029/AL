...
Crie um metodo que Ative o ZSWAP ou o ZRAM, deve ser um so metodo.
...
No arquivo sources.list por pagrao(estou utilizando o debian testing) vem escrito isso apos a instalacao do debian:
#deb cdrom:[Debian GNU/Linux testing _Forky_ - Official Snapshot amd64 NETINST with firmware 20260211-09:07]/ forky contrib main non-free-firmware
...
deb-src http://deb.debian.org/debian/ forky-updates main non-free-firmware
