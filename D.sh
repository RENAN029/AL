...
Nao se deve utilizar wget e sim curl no lugar. Alguns scripts eu botei do linuxtoys para vc usar de referencia de como fazer esses metodos funcionarem no debian(prioridade), eles sao os que pussuem a #!/bin/bash, sequida por outros paremetros como nome e versao.
